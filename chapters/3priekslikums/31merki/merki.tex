...
\begin{table}[!ht]
    \centering
    \begin{tabular}{|p{0.2\textwidth}|p{0.4\textwidth}|p{0.1\textwidth}|p{0.2\textwidth}|p{0.1\textwidth}|}
        \hline
        ...
        \hline
        Funkcionālā & Nodrošināt piejamību apgūt mācības dažādos veidos & === & Piejamības veidu skaits & Iekšējā uzskaite \\ %TODO
        \hline
